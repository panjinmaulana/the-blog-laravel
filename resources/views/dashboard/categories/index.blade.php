...
@section('container')
    ...
    <div class="table-responsive col-lg-6">
        <a href="/dashboard/categories/create" class="btn btn-primary mb-3">Create new category</a> {{-- href="/dashboard/categories/create" create disini otomatis nanti bakalan di tangkap sama method create(), karena kita menggunakan resource controller --}}
            ...
            <tbody>
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td>{{ $category->name }}</td>
                        <td>
                            <a href="/dashboard/categories/{{ $category->slug }}" class="badge bg-info"><span data-feather="eye" class="align-text-bottom"></span></a> {{-- ini bakalan menuju ke method show() --}}
